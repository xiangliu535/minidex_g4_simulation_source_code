...
class HPGeParticleSource: public G4VPrimaryGenerator
{
public:
	HPGeParticleSource();
	~HPGeParticleSource();
...
public:
    ...
    void GenerateCosmicNeutron();
    void GenerateCosmicNeutronDirection();
	void GenerateIsotropicFlux();

	void GenerateMonoEnergetic();
	void GenerateAmBe();
	void GeneratePb210Bremsstrahlung();

//---> fluka related
        void SetUseFlukaFlag(bool use_or_not) { Flag_Use_Fluka_Input_File = use_or_not; };
        void OpenFlukaInputFile();
        void ChangeFlukaInputFileName(G4String newFileName);
...
private:
	...
	G4int m_iVerbosityLevel;
 	TH1D* AmBe_n;
        TH1D* hflat100;
        TH1D* Pb210_Bremsstrahlung;
    	TF1* func_cosmic_neutron_flux;
	HPGeParticleSourceMessenger *m_pMessenger;
	G4Navigator *m_pNavigator;

// ---> fluka related
       G4String ConvertFlukaCodeToGeant4ParticleName(G4int fluka_code);
       G4String      fFlukaInputFileName;
       std::ifstream fFlukaInputFile;
       bool          Flag_Use_Fluka_Input_File;
};
