...
class HPGeParticleSourceMessenger: public G4UImessenger
{
public:
	HPGeParticleSourceMessenger(HPGeParticleSource *pParticleSource);
	~HPGeParticleSourceMessenger();
...
private:
	...
	G4ParticleTable *m_pParticleTable;
     ...
     G4UIcmdWithABool           *m_pFlukaUseCmd;
     G4UIcmdWithAString         *m_pFlukaInputFileCmd;
