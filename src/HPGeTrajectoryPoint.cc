...
G4Allocator<HPGeTrajectoryPoint> aTrajPointAllocator;

HPGeTrajectoryPoint::HPGeTrajectoryPoint()
      : fTime(0.), fEdep(0.), fStepLength(0.), 
        fPosition(0.,0.,0.), fMomentum(0.,0.,0.), 
        fStepStatus(fUndefined), fVolumeName(""), fProcessName("") { }

HPGeTrajectoryPoint::HPGeTrajectoryPoint(const G4Step* aStep)
...
HPGeTrajectoryPoint::HPGeTrajectoryPoint(const G4Track* aTrack)
    : G4TrajectoryPoint(aTrack->GetPosition())
{
// this is the very fist point of a track
     ...
     // G4cout<<" TrajectoryPoint in aTrack "<<fVolumeName<<G4endl;
}

HPGeTrajectoryPoint::HPGeTrajectoryPoint(const HPGeTrajectoryPoint &right)
...
const std::map<G4String,G4AttDef>* HPGeTrajectoryPoint::GetAttDefs() const
{
  G4bool isNew;
...
std::vector<G4AttValue>* HPGeTrajectoryPoint::CreateAttValues() const
{
