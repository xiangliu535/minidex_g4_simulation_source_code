...
#
########
repository=/ptmp/mpp/xliu/minidex_runvi_mc_run${ReSimulation_Number} # this is the folder where the output of the simulation will be stored - this folder needs to be created before u run the simulation to be created before you run the simulation                                                                        
...
/HPGe/det/GDMLsourceFile /afs/ipp-garching.mpg.de/home/x/xliu/work/minidex/minidex_g4_simulation_source_code/gdml_geometry/RunVI_geometry/MINIDEX_GDML_RunVI.gdml
